...
- **Left ribbon icon** opens a quick Group → Workspace switch menu (ungrouped sessions first, then each group, both sorted alphabetically), with a "Save current layout to session…" picker and a "Manage Workspaces" item at the bottom to jump straight into the full modal.
